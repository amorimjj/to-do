...
**Persona:** `@qa` (Quinn, Quality Assurance Lead). Load `.cursor/subagents/qa.md`.
...
2. **Automated checks:**
   - `npm run lint && npm run typecheck && npm run test && npm run e2e` (skip E2E if not feasible, note in report)
